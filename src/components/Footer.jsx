    ...
    <footer className="footer">
            ...
            <div className="footer__socials">
              {['LinkedIn', 'WhatsApp', 'Email'].map(s => (
                <a key={s} href="#" className="footer__social" aria-label={s}>
                  {s === 'LinkedIn' && <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z"/><circle cx="4" cy="4" r="2"/></svg>}
                  ...
                  {s === 'Email' && <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>}
                </a>
              ))}
            </div>
          </div>
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          <span>© {new Date().getFullYear()} VL Infra. All rights reserved.</span>
          <span className="footer__tagline">Protecting Lives · Securing Futures</span>
        </div>
      </div>
    </footer>
  );
