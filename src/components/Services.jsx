...
const TypewriterText = ({ text, isExpanded }) => {
  ...
  useEffect(() => {
    if (isExpanded) {
      ...
      let i = 0;
      // Use a fast interval for typing long text
      const intervalId = setInterval(() => {
        i += 2; // Type 2 characters at a time for smooth but fast effect
        if (i >= text.length) {
      ...
      // Reset immediately when collapsed
      setDisplayedText("");
    }
  }, [isExpanded, text]);

  if (!isExpanded && displayedText === "") return null;
    ...
    return (
      ...
      >
        <div className="service-row__content">
          ...
          <div className="service-row__desc-wrapper">
